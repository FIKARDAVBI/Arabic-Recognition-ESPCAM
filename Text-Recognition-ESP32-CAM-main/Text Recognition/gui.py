...
class predictGUI(QDialog):
    ...
    def update_frame(self):
        ...
        self.fig = cv2.resize(frame,(150,150))

    def predict_frame(self):
        h, w, ch = self.fig.shape
        bytes_per_line = ch * w
        q_img = QImage(self.fig.data, w, h, bytes_per_line, QImage.Format_RGB888)
        ...
        self.pred *= 100
        self.hasil2.setPixmap(QPixmap.fromImage(q_img))
